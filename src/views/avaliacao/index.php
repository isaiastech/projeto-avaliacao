    ...
    >
        ...
        >
            ...
            <div class="card-etapa">
                ...
                <button
                    type="button"
                    class="btn btn-principal btn-block btn-iniciar"
                >
            ...
            >
                ...
                <div class="card-etapa">
                    ...
                    <div class="navegacao">
                        ...
                        <button
                            type="button"
                            class="btn btn-principal btn-proximo"
                            disabled
                        >
            ...
            <div class="card-etapa">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        rows="6"
                        maxlength="2000"
                        placeholder="Digite aqui seus elogios, sugestões ou observações..."
                    ></textarea>
